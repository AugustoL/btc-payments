...
module.exports = function(conf,completeFunctions,cancelFunctions,warningFunctions) {
    ...
    require('./schemas')(db,logger,completeFunctions,cancelFunctions,warningFunctions); 
    ...
    module.removeOnWarning = function(name){
        if (warningFunctions[name]){
            var newFunctions = [];
            for (func in warningFunctions){
                if (func != name)
                    newFunctions[func] = warningFunctions[func];
            }
            warningFunctions = newFunctions;
        } else
            throw (name+' onWarning function cant be removed because it not exist');
    }

	// Add a onComplete fucntion using the name of the operation and a function(payment,callback){ //DO YOUR STUFF }  
    ...
    // Add a onCancel fucntion using the name of the operation and a function(payment,callback){ //DO YOUR STUFF }  
    ...
    // Add a onWarning fucntion using the name of the operation and a function(payment,callback){ //DO YOUR STUFF }  
    module.addOnWarning = function(name,func){ 
        if (!warningFunctions[name])
            warningFunctions[name] = func;
        else
            throw (name+' onWarning function cant be created because already exist');
    }

    // Change a onComplete fucntion using the name of the operation and a function(payment,callback){ //DO YOUR STUFF } 
